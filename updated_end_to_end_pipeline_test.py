#!/usr/bin/env python
"""
End-to-End Pipeline Test for Trading-Agent System
...
try:
    ...
    from flash_trading_signals import FlashTradingSignals as SignalGenerator
    from fixed_paper_trading import PaperTradingSystem
    from enhanced_telegram_notifications import TelegramNotifier
    from signal_generator_adapter import SignalGeneratorAdapter
...
def run_end_to_end_test():
    ...
    # Create specialized signal generator adapter for the data service
    signal_generator_adapter = SignalGeneratorAdapter(data_service)
    ...
    # Initialize signal generator - Use specialized adapter to ensure interface compatibility
    signal_generator = SignalGenerator(
        client_instance=signal_generator_adapter
    )
