"""
Tests for the Twitter API collector.
"""
...
from ai_trading_agent.sentiment_analysis.collectors.twitter_collector import TwitterAPICollector


class TestTwitterAPICollector(unittest.TestCase):
    """Test the Twitter API collector."""

    def setUp(self):
        """Set up test fixtures."""
        # Create cache directory if it doesn't exist
        os.makedirs("tests/data/cache/twitter", exist_ok=True)
        
        self.collector = TwitterAPICollector(
            cache_dir="tests/data/cache/twitter",
            cache_expiry=3600,
    ...
    def test_fetch_sentiment_data(self):
        ...
        # Check that source is "twitter"
        self.assertTrue(all(df["source"] == "twitter"))
