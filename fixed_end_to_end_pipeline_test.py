#!/usr/bin/env python
"""
End-to-End Pipeline Test with Fixed Error Handling
...
Uses the refactored FlashTradingSignals class and fixed error handling utilities.
"""
...
# Import fixed error handling utilities first to ensure they're used
from fixed_error_handling_utils import validate_api_response, handle_api_error, log_exception
...
try:
    ...
    from refactored_flash_trading_signals import FlashTradingSignals as SignalGenerator
