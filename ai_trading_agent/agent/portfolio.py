...
class BasePortfolioManager(PortfolioManagerABC):
    ...
    def update_fill(self, order: Order) -> None:
        ...
        quantity = order.get('executed_quantity') # Quantity actually filled (Use executed_quantity)
        price = order.get('executed_price')    # Average price of the fill (Use executed_price)
